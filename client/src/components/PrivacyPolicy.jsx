...
const PrivacyPolicy = () => {
	return (
		<Container className="my-5 privacy-policy">
			<h1>Privacy Policy for CodeMyResume</h1>

			<p>
				At CodeMyResume, accessible from codemyresume.com, one of our
				...
				and recorded by CodeMyResume and how we use it.
			</p>
			...
			<p>
				...
				information that they shared and/or collect in CodeMyResume.
			...
			<p>
				CodeMyResume follows a standard procedure of using log files.
			...
			<p>
				Like any other website, CodeMyResume uses 'cookies'. These
			...
			<p>
				...
				the advertising partners of CodeMyResume.
			</p>

			<p>
				Third-party ad servers or ad networks uses technologies like
				cookies, JavaScript, or Web Beacons that are used in their
				respective advertisements and links that appear on CodeMyResume,
			...
			<p>
				Note that CodeMyResume has no access to or control over these
			...
			<p>
				CodeMyResume's Privacy Policy does not apply to other
			...
			<p>
				The right to access &minus You have the right to request copies
				of your personal data. We may charge you a small fee for this
				service.
			</p>
			<p>
				The right to rectification &minus You have the right to request
			...
			<p>
				The right to erasure &minus You have the right to request that
				we erase your personal data, under certain conditions.
			</p>
			<p>
				The right to restrict processing &minus You have the right to
				request that we restrict the processing of your personal data,
				under certain conditions.
			</p>
			<p>
				The right to object to processing &minus You have the right to
				object to our processing of your personal data, under certain
				conditions.
			</p>
			<p>
				The right to data portability &minus You have the right to
			...
			<p>
				CodeMyResume does not knowingly collect any Personal
