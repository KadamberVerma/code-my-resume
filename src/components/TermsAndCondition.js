...
const TermsAndCondition = () => {
	return (
		<Container className="my-5 terms-and-condition">
			<h2>
				<strong>Terms and Conditions</strong>
			</h2>

			<p>Welcome to CodeMyResume!</p>

			<p>
				These terms and conditions outline the rules and regulations for
				the use of CodeMyResume's Website, located at codemyresume.com.
			</p>

			<p>
				By accessing this website we assume you accept these terms and
				conditions. Do not continue to use CodeMyResume if you do not
			...
			<p>
				We employ the use of cookies. By accessing CodeMyResume, you
				agreed to use cookies in agreement with the CodeMyResume's
				Privacy Policy.{' '}
			</p>
			...
			<p>
				Unless otherwise stated, CodeMyResume and/or its licensors own
				the intellectual property rights for all material on
				CodeMyResume. All intellectual property rights are reserved. You
				may access this from CodeMyResume for your own personal use
				subjected to restrictions set in these terms and conditions.
			</p>

			<p>You must not:</p>
			<ul>
				<li>Republish material from CodeMyResume</li>
				<li>Sell, rent or sub-license material from CodeMyResume</li>
				<li>Reproduce, duplicate or copy material from CodeMyResume</li>
				<li>Redistribute content from CodeMyResume</li>
			</ul>
			...
			<p>
				...
				website. CodeMyResume does not filter, edit, publish or review
				Comments prior to their presence on the website. Comments do not
				reflect the views and opinions of CodeMyResume,its agents and/or
				affiliates. Comments reflect the views and opinions of the
				person who post their views and opinions. To the extent
				permitted by applicable laws, CodeMyResume shall not be liable
			...
			<p>
				CodeMyResume reserves the right to monitor all Comments and to
			...
			<p>
				You hereby grant CodeMyResume a non-exclusive license to use,
			...
			<p>
				...
				of CodeMyResume; and (d) the link is in the context of general
			...
			<p>
				...
				by sending an e-mail to CodeMyResume. Please include your name,
			...
			<p>
				No use of CodeMyResume's logo or other artwork will be allowed
